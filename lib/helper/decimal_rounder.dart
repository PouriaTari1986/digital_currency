...
class DecimalRounder {
  ...
  static String removePriceDecimal(dynamic price){
    String finalPrice;
    if(price < 1){
  ...
  static String removeChartPriceDecimal(dynamic price){
    String finalPrice;
    if(price < 1){
      finalPrice = price.toStringAsFixed(4);
    }else if(price < 10){
    ...
    static String removePercentDecimal(dynamic percent24){
    ...
    static MaterialColor setColorFilter(dynamic percent24){
    ...
    static Color setPercentChangeColor(dynamic percent24){
    Color percentColor;
    if(percent24 < 0){
    ...
    static Icon setPercentChangeIcon(dynamic percent24){
    Icon percentIcon;
    if(percent24 < 0){
